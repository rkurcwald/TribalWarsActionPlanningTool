...
public class Map extends JPanel {
    ...
    public static final Color VILLAGE=new Color(139,69,19);
    
    public static List<String> cordsList=new ArrayList<String>();
    ...
    public void addCords(GetDataFromAPI gda)
    {
    	ArrayList<String> villageCopy= gda.getVillageData();
    	for(int i=0;i<villageCopy.size();i++)
    	{
    		String[] splittedVillageData=villageCopy.get(i).split(",");
    		cordsList.add(splittedVillageData[2]+","+splittedVillageData[3]);
   ...
   /* 	CORDS.add("464,467");
     ...
     //   {
      //  	for (int j = 0; j < NUM_COLS; j++)
       // 	{
        //		if(i!=250 && j!=250)
        //		{
        	        for(int k=0;k<cordsList.size();k++)
        	        {
        	        	cordsTable=cordsList.get(k).split(",");
            ...
            //				System.out.println("2Y   "+cordX);
        	        	...
        	        	this.terrainGrid[cordX][cordY] = VILLAGE;
        	        }
    ...
    public void paintComponent(Graphics g) {
        ...
        // Draw the grid
        int rectWidth;// = getWidth()/ NUM_COLS;  //MAKING SQUARE
        int rectHeight =rectWidth= getHeight()/ NUM_ROWS;
